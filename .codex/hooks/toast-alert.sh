...
# Forces the terminal window running this Codex session to the
# foreground when Codex finishes responding, so the user notices even
...
# Codex window. The PowerShell process is launched detached so this
